<?php
    /*
    *   需搭配 SDK(ECPay.Payment.Integration.php) 使用
    */
    ...
    abstract class ServiceURL {
        const PROD_CO = 'https://payment.ecpay.com.tw/Cashier/AioCheckOut/V2';
        const STAGE_CO = 'https://payment-stage.ecpay.com.tw/Cashier/AioCheckOut/V2';
        const PROD_QO = 'https://payment.ecpay.com.tw/Cashier/QueryTradeInfo/V2';
        const STAGE_QO = 'https://payment-stage.ecpay.com.tw/Cashier/QueryTradeInfo/V2';
    }
    ...
    abstract class LogMsg {
        const RESP_DES = 'Recive ECPay response.';
        const RESP_RES = 'Processed result: %s';
    }
    
    abstract class ErrorMsg {
        const EXT_MISS = 'ECPay extension missed.';
        const C_FD_EMPTY = 'ECPay checkout feedback is empty.';
        const Q_FD_EMPTY = 'ECPay query feedback is empty.';
    ...
    abstract class CommentTpl {
        ...
        const GC_BARCODE = 'Payment Deadline: %s<br>BARCODE 1 : %s<br>BARCODE 2 : %s<br>BARCODE 3 : %s<br>';
    ...
    class ECPayExt {
        ...
        public function getPayment($payment_name) {
            $payment = array(
                'Credit' => ECPay_PaymentMethod::Credit,
                'WebATM' => ECPay_PaymentMethod::WebATM,
                'ATM' => ECPay_PaymentMethod::ATM,
                'CVS' => ECPay_PaymentMethod::CVS,
                'BARCODE' => ECPay_PaymentMethod::BARCODE,
            );
        ...
        public function getGetcodeTpl($payment) {
            $gc_tpl = array(
                ECPay_PaymentMethod::ATM => CommentTpl::GC_ATM,
                ECPay_PaymentMethod::CVS => CommentTpl::GC_CVS,
                ECPay_PaymentMethod::BARCODE => CommentTpl::GC_BARCODE
            );
        ...
        public function getReturnType($payment, $rtn_code) {
            $return_type = '';
            $gc_code = array(
                ECPay_PaymentMethod::ATM => ReturnCode::GC_ATM,
                ECPay_PaymentMethod::CVS => ReturnCode::GC_CVS,
                ECPay_PaymentMethod::BARCODE => ReturnCode::GC_BARCODE
            );
